...
// const Body = tw.div`min-w-full min-h-screen bg-gray-900 flex items-center justify-center px-5 py-5`;
...
`;
const Container_mx = tw.div`bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden max-w-screen-lg`;
const Container_form = tw.div`md:flex w-full`;
const Left_form = tw.div`hidden md:block w-1/2 bg-Green-light py-10 px-10`;
const Right_form = tw.div`w-full md:w-1/2 py-10 px-5 md:px-10`;
const Right_form_center = tw.div`text-center mb-10`;
...
const Container_Input = tw.input`w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-Green-default`;
const Submit = tw.button`block w-full max-w-xs mx-auto bg-Green-default hover:bg-Green-light focus:bg-Green-default text-white rounded-lg px-3 py-3 font-semibold`;
                ...
                <Formik
                    ...
                    <Position>
                        <Container_Name>
                            ...
                            <PositionInput>
                            <PositionIcon><Icon>person</Icon></PositionIcon>
                            <Container_Input  name="name" type="text" placeholder="Desori" required/>
                        </PositionInput>
                        </Container_Name>
                        ...
                        <Container_Name>
                            ...
                            <PositionInput>
                            <PositionIcon><Icon>person</Icon></PositionIcon>
                            <Container_Input  name="surname" type="text" placeholder="Guillaume"/>
                            </PositionInput>
                        </Container_Name>    
                    </Position>
                    <Position>
                        <Container_Email>
                            <Label>Email</Label>
                            <PositionInput>
                            <PositionIcon><Icon>alternate_email</Icon></PositionIcon>
                            <Container_Input  name="email" type="text" placeholder="Guillaume.de@gmail.com"/>
                            </PositionInput>
                        </Container_Email>
                    </Position>
                    <Position>
                        <Container_Password>
                            ...
                            <PositionInput>
                            <PositionIcon><Icon>https</Icon></PositionIcon>
                            <Container_Input  name="password" type="text" placeholder="*************"/>
                            </PositionInput>
                        </Container_Password>
                    </Position>
                    <Position>
                        <Container_Button>
                          <Submit type="submit">S'INSCRIRE MAINTENANT</Submit>
                        </Container_Button>
                    </Position>
                    </Form>)}
                    </Formik>
